...
import core.value.basic.BooleanValue.BooleanConstant
import core.value.basic.ByteValue.{ByteConstant, NumericToByte}
import core.value.basic.CharValue.CharConstant
import core.value.basic.DoubleValue.{DoubleConstant, NumericToDouble}
import core.value.basic.FloatValue.{FloatConstant, NumericToFloat}
import core.value.basic.IntValue.{IntConstant, NumericToInt}
import core.value.basic.LongValue.{LongConstant, NumericToLong}
import core.value.basic.ShortValue.{NumericToShort, ShortConstant}
import core.value.basic.StringValue.{NumericToString, StringConstant}
