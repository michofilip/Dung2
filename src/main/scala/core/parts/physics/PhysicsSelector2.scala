...
sealed abstract class PhysicsSelector2 {
    val id: String
...
object PhysicsSelector2 {
    
    case object LeverPhysicsSelector extends PhysicsSelector2 {
    ...
    case object DoorPhysicsSelector extends PhysicsSelector2 {
